 ...
 */
public class KakaoStorySignActivity extends SampleSignupActivity {
    ...
    protected void redirectMainActivity() {
    	...
    	if(PopupLinkButton.getinstance() != null){
			...
			PopupLinkButton.getinstance().SendKakaoStory();
			PopupLinkButton.getinstance().dismiss();
//	    		PopupLinkButton.getinstance().SendKakaoStory();
	    	
//    		new Popup1Button(KakaoStorySignupActivity.this, getResources().getStringArray(R.array.kakaostory_spinner), new Dialog.OnClickListener() {
//				@Override
