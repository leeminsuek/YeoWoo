...
public class ResizeVideoImageView extends ImageView
{
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		if(d != null){			
			...
			int screenHeight = (int)TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 230, getResources().getDisplayMetrics());;

			int margin10 = (int)TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 7, getResources().getDisplayMetrics());
